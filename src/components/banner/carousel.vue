<template>
  ...
  <script>
  import CarouselItem from "@/components/banner/carouselItem.vue";
  import CarouselControls from "@/components/banner/carouselControls.vue";
  import CarouselIndicators from "@/components/banner/carouselIndicators.vue";
  export default {
    name:"Carousel",
    props: {
